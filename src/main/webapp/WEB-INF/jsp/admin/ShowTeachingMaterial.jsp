...
<div >
    ...
    <div style="width: 100%">
            ...
            <c:forEach var="teachingMaterial" items="${TeachingMaterials}">
                <div class="container">
                <div class="row" >
                    <div class="col-lg-10 col-md-10"  id="${notice.id}">
                        <div style="color: #3d3395;font-size: 18px"><b>${teachingMaterial.name}</b></div>
                        ${teachingMaterial.description}<br>
                        <a href="${contextPath}/${teachingMaterial.file}">${teachingMaterial.file}</a>
                    </div>
                    <div class="col-lg-2 col-md-2">
                        Date - ${teachingMaterial.date}<br>
                        <a href="${contextPath}/admin/deleteMaterial/${teachingMaterial.id}">
                            <div>
                            <img height="27px" width="27px" src="<c:url value="/resources/image/delete.png" />">
                            <span>Remove</span></div>
                        </a>

                        <a href="${contextPath}/admin/showMaterialVisitedStudents/${teachingMaterial.id}">
                            <div>
